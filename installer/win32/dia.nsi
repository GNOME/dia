...
!endif    
    ...
    SetOverwrite off
    CreateShortCut "$SMPROGRAMS\Dia\Uninstall Dia.lnk" "$INSTDIR\${DIA_UNINST_EXE}"
 ...
 LoopRead:
  ClearErrors
   ...
   Pop $R0
    ...
    Delete "$SMPROGRAMS\Dia\Uninstall Dia.lnk"
	...
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_TW\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_TW"
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_HK\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_HK"
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_CN\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\zh_CN"
	RMDir /REBOOTOK "$INSTDIR\share\locale\yi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\yi"
	RMDir /REBOOTOK "$INSTDIR\share\locale\xh\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\xh"
	RMDir /REBOOTOK "$INSTDIR\share\locale\wa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\wa"
	RMDir /REBOOTOK "$INSTDIR\share\locale\vi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\vi"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uz@cyrillic\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uz@cyrillic"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uz\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uz"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ur\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ur"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\uk"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tt"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tr"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tl"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\tk"
	RMDir /REBOOTOK "$INSTDIR\share\locale\th\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\th"
	RMDir /REBOOTOK "$INSTDIR\share\locale\te\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\te"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ta\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ta"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sv"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr@latin\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr@latin"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr@ije\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr@ije"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sr"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sq\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sq"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sl"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\sk"
	RMDir /REBOOTOK "$INSTDIR\share\locale\rw\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\rw"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ru\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ru"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ro\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ro"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pt_BR\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pt_BR"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pt"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pl"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\pa"
	RMDir /REBOOTOK "$INSTDIR\share\locale\or\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\or"
	RMDir /REBOOTOK "$INSTDIR\share\locale\oc\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\oc"
	...
	RMDir /REBOOTOK "$INSTDIR\share\locale\nb\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\nb"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ms\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ms"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mr"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mn"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ml\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ml"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mk"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\mi"
	RMDir /REBOOTOK "$INSTDIR\share\locale\lv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\lv"
	RMDir /REBOOTOK "$INSTDIR\share\locale\lt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\lt"
	RMDir /REBOOTOK "$INSTDIR\share\locale\li\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\li"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ku\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ku"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ko\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ko"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ka\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ka"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ja\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ja"
	RMDir /REBOOTOK "$INSTDIR\share\locale\it\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\it"
	RMDir /REBOOTOK "$INSTDIR\share\locale\is\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\is"
	RMDir /REBOOTOK "$INSTDIR\share\locale\id\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\id"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ia\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ia"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hy\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hy"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hu"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hr"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\hi"
	RMDir /REBOOTOK "$INSTDIR\share\locale\he\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\he"
	RMDir /REBOOTOK "$INSTDIR\share\locale\gu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\gu"
	RMDir /REBOOTOK "$INSTDIR\share\locale\gl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\gl"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ga\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ga"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fr"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fi"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\fa"
	RMDir /REBOOTOK "$INSTDIR\share\locale\eu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\eu"
	RMDir /REBOOTOK "$INSTDIR\share\locale\et\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\et"
	RMDir /REBOOTOK "$INSTDIR\share\locale\es\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\es"
	RMDir /REBOOTOK "$INSTDIR\share\locale\eo\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\eo"
	RMDir /REBOOTOK "$INSTDIR\share\locale\en_GB\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\en_GB"
	RMDir /REBOOTOK "$INSTDIR\share\locale\en_CA\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\en_CA"
	RMDir /REBOOTOK "$INSTDIR\share\locale\el\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\el"
	RMDir /REBOOTOK "$INSTDIR\share\locale\dz\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\dz"
	RMDir /REBOOTOK "$INSTDIR\share\locale\de\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\de"
	RMDir /REBOOTOK "$INSTDIR\share\locale\da\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\da"
	RMDir /REBOOTOK "$INSTDIR\share\locale\cy\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\cy"
	RMDir /REBOOTOK "$INSTDIR\share\locale\cs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\cs"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ca\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ca"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bs"
	RMDir /REBOOTOK "$INSTDIR\share\locale\br\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\br"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bn_IN\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bn_IN"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bn"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bg\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\bg"
	RMDir /REBOOTOK "$INSTDIR\share\locale\be@latin\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\be@latin"
	RMDir /REBOOTOK "$INSTDIR\share\locale\be\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\be"
	RMDir /REBOOTOK "$INSTDIR\share\locale\az_IR\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\az_IR"
	RMDir /REBOOTOK "$INSTDIR\share\locale\az\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\az"
	RMDir /REBOOTOK "$INSTDIR\share\locale\as\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\as"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ar\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ar"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ang\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\ang"
	RMDir /REBOOTOK "$INSTDIR\share\locale\am\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\am"
	RMDir /REBOOTOK "$INSTDIR\share\locale\af\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\share\locale\af"
	RMDir /REBOOTOK "$INSTDIR\share\locale"
	RMDir /REBOOTOK "$INSTDIR\share"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_TW\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_TW"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_HK\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_HK"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_CN\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\zh_CN"
	RMDir /REBOOTOK "$INSTDIR\locale\vi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\vi"
	RMDir /REBOOTOK "$INSTDIR\locale\uk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\uk"
	RMDir /REBOOTOK "$INSTDIR\locale\tr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\tr"
	RMDir /REBOOTOK "$INSTDIR\locale\th\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\th"
	RMDir /REBOOTOK "$INSTDIR\locale\sv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sv"
	RMDir /REBOOTOK "$INSTDIR\locale\sr@Latn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sr@Latn"
	RMDir /REBOOTOK "$INSTDIR\locale\sr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sr"
	RMDir /REBOOTOK "$INSTDIR\locale\sq\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sq"
	RMDir /REBOOTOK "$INSTDIR\locale\sl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sl"
	RMDir /REBOOTOK "$INSTDIR\locale\sk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\sk"
	RMDir /REBOOTOK "$INSTDIR\locale\rw\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\rw"
	RMDir /REBOOTOK "$INSTDIR\locale\ru\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ru"
	RMDir /REBOOTOK "$INSTDIR\locale\ro\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ro"
	RMDir /REBOOTOK "$INSTDIR\locale\pt_BR\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\pt_BR"
	RMDir /REBOOTOK "$INSTDIR\locale\pt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\pt"
	RMDir /REBOOTOK "$INSTDIR\locale\pl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\pl"
	RMDir /REBOOTOK "$INSTDIR\locale\pa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\pa"
	RMDir /REBOOTOK "$INSTDIR\locale\oc\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\oc"
	...
	RMDir /REBOOTOK "$INSTDIR\locale\nb\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\nb"
	RMDir /REBOOTOK "$INSTDIR\locale\ms\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ms"
	RMDir /REBOOTOK "$INSTDIR\locale\mr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\mr"
	RMDir /REBOOTOK "$INSTDIR\locale\mn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\mn"
	RMDir /REBOOTOK "$INSTDIR\locale\ml\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ml"
	RMDir /REBOOTOK "$INSTDIR\locale\mk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\mk"
	RMDir /REBOOTOK "$INSTDIR\locale\lv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\lv"
	RMDir /REBOOTOK "$INSTDIR\locale\lt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\lt"
	RMDir /REBOOTOK "$INSTDIR\locale\ko\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ko"
	RMDir /REBOOTOK "$INSTDIR\locale\kn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\kn"
	RMDir /REBOOTOK "$INSTDIR\locale\ja\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ja"
	RMDir /REBOOTOK "$INSTDIR\locale\it\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\it"
	RMDir /REBOOTOK "$INSTDIR\locale\is\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\is"
	RMDir /REBOOTOK "$INSTDIR\locale\id\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\id"
	RMDir /REBOOTOK "$INSTDIR\locale\hu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\hu"
	RMDir /REBOOTOK "$INSTDIR\locale\hr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\hr"
	RMDir /REBOOTOK "$INSTDIR\locale\gu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\gu"
	RMDir /REBOOTOK "$INSTDIR\locale\gl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\gl"
	RMDir /REBOOTOK "$INSTDIR\locale\ga\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ga"
	RMDir /REBOOTOK "$INSTDIR\locale\fr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\fr"
	RMDir /REBOOTOK "$INSTDIR\locale\fi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\fi"
	RMDir /REBOOTOK "$INSTDIR\locale\eu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\eu"
	RMDir /REBOOTOK "$INSTDIR\locale\es\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\es"
	RMDir /REBOOTOK "$INSTDIR\locale\en_GB\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\en_GB"
	RMDir /REBOOTOK "$INSTDIR\locale\en_CA\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\en_CA"
	RMDir /REBOOTOK "$INSTDIR\locale\el\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\el"
	RMDir /REBOOTOK "$INSTDIR\locale\dz\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\dz"
	RMDir /REBOOTOK "$INSTDIR\locale\de\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\de"
	RMDir /REBOOTOK "$INSTDIR\locale\da\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\da"
	RMDir /REBOOTOK "$INSTDIR\locale\cs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\cs"
	RMDir /REBOOTOK "$INSTDIR\locale\ca@valencia\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ca@valencia"
	RMDir /REBOOTOK "$INSTDIR\locale\ca\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ca"
	RMDir /REBOOTOK "$INSTDIR\locale\bs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\bs"
	RMDir /REBOOTOK "$INSTDIR\locale\bg\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\bg"
	RMDir /REBOOTOK "$INSTDIR\locale\be\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\be"
	RMDir /REBOOTOK "$INSTDIR\locale\az\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\az"
	RMDir /REBOOTOK "$INSTDIR\locale\ast\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ast"
	RMDir /REBOOTOK "$INSTDIR\locale\ar\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\ar"
	RMDir /REBOOTOK "$INSTDIR\locale\am\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\locale\am"
	RMDir /REBOOTOK "$INSTDIR\locale"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_TW\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_TW"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_HK\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_HK"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_CN\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\zh_CN"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\yi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\yi"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\xh\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\xh"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\wa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\wa"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\vi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\vi"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\uk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\uk"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ug\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ug"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tt"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tr"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\tk"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\th\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\th"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\te\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\te"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ta\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ta"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sv"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr@latin\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr@latin"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr@ije\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr@ije"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sr"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sq\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sq"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sl"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\sk"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\rw\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\rw"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ru\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ru"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ro\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ro"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pt_BR\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pt_BR"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pt"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pl"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\pa"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\or\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\or"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\oc\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\oc"
	...
	RMDir /REBOOTOK "$INSTDIR\lib\locale\nb\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\nb"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ms\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ms"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mr"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mn"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ml\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ml"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mk\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\mk"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\lv\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\lv"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\lt\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\lt"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\li\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\li"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ku\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ku"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ko\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ko"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\kn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\kn"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ka\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ka"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ja\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ja"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\it\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\it"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\is\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\is"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\id\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\id"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hu"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hr"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\hi"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\he\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\he"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\gu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\gu"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\gl\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\gl"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ga\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ga"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fr\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fr"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fi\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fi"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fa\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\fa"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\eu\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\eu"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\et\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\et"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\es\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\es"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\eo\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\eo"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\en_GB\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\en_GB"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\en_CA\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\en_CA"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\el\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\el"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\dz\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\dz"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\de\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\de"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\da\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\da"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\cy\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\cy"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\cs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\cs"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ca\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ca"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bs\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bs"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bn_IN\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bn_IN"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bn\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bn"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bg\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\bg"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\be@latin\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\be@latin"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\be\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\be"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\az\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\az"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\as\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\as"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ar\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\ar"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\am\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\am"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\af\LC_MESSAGES"
	RMDir /REBOOTOK "$INSTDIR\lib\locale\af"
	RMDir /REBOOTOK "$INSTDIR\lib\locale"
